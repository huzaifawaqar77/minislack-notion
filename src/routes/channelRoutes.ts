...
router.post("/workspaces/:workspaceId/channels", authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  await createChannelController(req, res);
});

router.get("/workspaces/:workspaceId/channels", authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
...
router.put("/channels/:id", authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
...
router.get("/channels/:id/members", authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  await getChannelMembersController(req, res);
});

router.post("/channels/:id/members", authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  await addChannelMemberController(req, res);
});

router.delete("/channels/:id/members/:userId", authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
