 ...
 */
export async function getChannelsController(req: AuthenticatedRequest, res: Response) {
  try {
    const { workspaceId } = req.params;
    ...
    const channels = await channelRepository.getChannelsForUser(workspaceId, req.user.id);
 ...
 */
export async function getChannelController(req: AuthenticatedRequest, res: Response) {
  try {
    const { id } = req.params;
...
export async function updateChannelController(req: AuthenticatedRequest, res: Response) {
  try {
    ...
    const channel = await channelRepository.updateChannel(id, {
      name,
      description,
      isPrivate
    }, req.user.id);
 ...
 */
export async function getChannelMembersController(req: AuthenticatedRequest, res: Response) {
  try {
    const { id } = req.params;
 ...
 */
export async function addChannelMemberController(req: AuthenticatedRequest, res: Response) {
  try {
    const { id } = req.params;
    ...
    const member = await channelRepository.addChannelMember(id, userId, req.user.id);
 ...
 */
export async function removeChannelMemberController(req: AuthenticatedRequest, res: Response) {
  try {
